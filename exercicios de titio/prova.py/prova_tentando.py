...
inicio = ["id", "descrição", "comclusão"]
with open('listas.csv', "w", newline="") as slaarquivo:
   escrevendo_csv = csv.DictReader(slaarquivo, fieldnames=inicio)
